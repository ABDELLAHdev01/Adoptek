...
export class UserEffect {
      ...
      mergeMap((action) =>
        this.authService.register(action.user).pipe(
          ...
          catchError((errorMessage) => [
            UserActions.registerFailure({ errorMessage }),
          ])
        )
      )
    )
    ...
    this.actions$.pipe(
      ...
      mergeMap((action) =>
        this.authService.login(action.user).pipe(
          ...
          catchError((errorMessage) => [
            UserActions.loginFailure({ errorMessage }),
          ])
        )
      )
    )
  ...
  checkJwtValidity$ = createEffect(() =>
    this.actions$.pipe(
      ofType(UserActions.checkJwtValidity),
      mergeMap((action) =>
        this.checkJwtValidityService.checkJwtValidity(action.token).pipe(
          map(() => UserActions.checkJwtValiditySuccess()),
          catchError((errorMessage) => [
            UserActions.checkJwtValidityFailure({ errorMessage }),
          ])
        )
      )
    )
  ...
  checkJwtValidityFailure$ = createEffect(
    () =>
      this.actions$.pipe(
  ...
  checkJwtValiditySuccess$ = createEffect(
    () => this.actions$.pipe(ofType(UserActions.checkJwtValiditySuccess)),
    { dispatch: false }
  );
  ...
  getUserSuccess$ = createEffect(
    () => this.actions$.pipe(ofType(UserActions.getUserSuccess)),
    { dispatch: false }
  );
    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.authService.getAllUsers().pipe(
          ...
          catchError((errorMessage) => [
            UserActions.getAllUsersFailure({ errorMessage }),
          ])
        )
      )
    )
  ...
  getAllUsersSuccess$ = createEffect(
    () => this.actions$.pipe(ofType(UserActions.getAllUsersSuccess)),
    { dispatch: false }
  );

  promoteUserToAdmin$ = createEffect(() =>
    this.actions$.pipe(
      ofType(UserActions.promoteUserToAdmin),
      mergeMap((action) =>
        this.authService.promoteUserToAdmin(action.email).pipe(
          map(() => UserActions.promoteUserToAdminSuccess()),
          catchError((errorMessage) => [
            UserActions.promoteUserToAdminFailure({ errorMessage }),
          ])
        )
      )
    )
  ...
  promoteUserToAdminSuccess$ = createEffect(
    () =>
      this.actions$.pipe(
  ...
  promoteUserToAdminFailure$ = createEffect(
    () =>
      this.actions$.pipe(
